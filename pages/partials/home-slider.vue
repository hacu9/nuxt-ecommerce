    ...
    <el-carousel height="100vh">
        <el-carousel-item>
            <div class="page-header header-filter">
                <div class="page-header-image" :style="{ backgroundImage: 'url(' + require(`@/assets/img/bg20.jpg`) + ')' }">
                    <!-- style="background-image: url('../../shared/img/bg20.jpg')" -->
        ...
        <el-carousel-item>
            <div class="page-header header-filter">
                <div class="page-header-image" :style="{ backgroundImage: 'url(' + require(`@/assets/img/bg15.jpg`) + ')' }">
                    >
                </div>
                <div class="content-center">
                    <div class="container">
        ...
        <el-carousel-item>
            <div class="page-header header-filter">
                <div class="page-header-image" v-lazy:background-image="require(`@/assets/img/bg17.jpg`)">
                    <!--  :style="{ backgroundImage: 'url(' + require(`@/assets/img/bg17.jpg`) + ')' }" -->
                </div>
                <div class="content-center">
                    <div class="container">
                        <div class="content-center">
...
<script>
import { FormGroupInput, Button } from "@/components/now-ui-kit";
